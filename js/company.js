...
function showSlides() {
  ...
  slideIndex++;
  //  thay đổi logo trắng và đen
  // if(slideIndex>2 & slideIndex <5 ){document.getElementById("logo").src="./images/hongson-light.png";}
  // else{
  //   document.getElementById("logo").src="./images/honson.png";
  // } 
   
  if (slideIndex > slides.length) {slideIndex = 1}
  // slider đến vị trí thứ 3 thì đổi logo qua logo trắng 
...
// changeLogo();
// function changeLogo(){
//   var change = document.getElementById("slideChange");
//   if(change.style.display="block"){
//     document.getElementById("logo").src="./images/hongson-light.png";
//   }
...
window.onscroll = function() {
  ...
  function scrollFunction() {
    if (document.body.scrollTop > 100 || document.documentElement.scrollTop > 100) {
      ...
      document.getElementById("menu1").classList.add("bgd");
    ...
    //   document.getElementById("icon-barr").style.color="#222222";
      ...
      document.getElementById("menu1").classList.remove("bgd");
